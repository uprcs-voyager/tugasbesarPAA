list_antrean = [
    ...
    def tampilkanSemuaPasien(self):
        print(f"[{self.id_pasien}] {self.nama_pasien} ({self.jenis_kelamin}, {self.umur} thn) - Gejala: {self.gejala} | Skor: {self.skor}")
...
list_antrean = [
    # Kategori: Gawat Darurat (Skor 41 - 50)
    Pasien("P001", "Budi Santoso", "L", 45, "Henti Jantung", 50),
    Pasien("P002", "Siti Aminah", "P", 30, "Trauma Kepala Berat", 41),
    Pasien("P003", "Andi Wijaya", "L", 62, "Stroke Akut", 41),
    Pasien("P004", "Rini Lestari", "P", 25, "Pendarahan Hebat", 41),
    ...
    # Kategori: Menengah (Skor 21 - 30)
    Pasien("P009", "Hendra Wijaya", "L", 41, "Krisis Hipertensi", 30),
    Pasien("P010", "Nina Kartika", "P", 22, "Nyeri Akut Usus Buntu", 30),
    Pasien("P011", "Fajar Ramadhan", "L", 15, "Demam Berdarah (DHF)", 30),
    Pasien("P012", "Tari Handayani", "P", 65, "Vertigo Berat", 30),
